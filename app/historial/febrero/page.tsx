          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4, marginBottom: 12 }}>
              ...
              <Link href="/historial/febrero" style={{ textDecoration: 'none' }}>
                <span className="hover:bg-[#e8eded] transition-colors" style={{ display: 'block', padding: '6px 12px 6px 52px', color: '#111827', fontSize: 13, fontWeight: 600, cursor: 'pointer', borderRadius: 4 }}>febrero</span>
              </Link>
