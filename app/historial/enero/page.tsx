  ...
  return (
    <div className={`min-h-screen flex flex-col ${inter.className}`} style={{ backgroundColor: '#edf2f2' }}>
      ...
      <main style={{ flex: 1, maxWidth: 1200, margin: '0 auto', width: '100%', padding: '32px 16px', display: 'flex', gap: 40 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2, paddingLeft: 12, marginBottom: 8 }}>
                ...
                <Link href="/historial/enero" style={{ textDecoration: 'none' }}>
                  <button className="hover:bg-[#f3f4f6] transition-colors" style={{ display: 'block', width: '100%', textAlign: 'left', border: 'none', background: '#f3f4f6', padding: '6px 12px', color: '#111827', fontSize: 14, cursor: 'pointer', fontWeight: 600, borderRadius: 4 }}>marzo</button>
                </Link>
              </div>
            </div>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ marginBottom: 12 }}><p style={{ fontSize: 13, color: '#6b7280', margin: 0 }}>marzo de 2026</p></div>
